...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Evaluation.datetime'
        db.add_column(u'opendata_evaluation', 'datetime',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 12, 1, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'InternetResource.datetime'
        db.add_column(u'opendata_internetresource', 'datetime',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 12, 1, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Evaluation.datetime'
        db.delete_column(u'opendata_evaluation', 'datetime')

        # Deleting field 'InternetResource.datetime'
        db.delete_column(u'opendata_internetresource', 'datetime')
