...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InternetResource.name'
        db.add_column(u'opendata_internetresource', 'name',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InternetResource.name'
        db.delete_column(u'opendata_internetresource', 'name')
