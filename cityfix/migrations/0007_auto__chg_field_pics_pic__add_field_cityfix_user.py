...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cityfix_pics', 'pic', self.gf('django.db.models.fields.TextField')(null=True))
        # Adding field 'CityFix.user'
        db.add_column(u'cityfix_cityfix', 'user',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CityFix.user'
        db.delete_column(u'cityfix_cityfix', 'user_id')
    ...
    models = {
        ...
        u'cityfix.cityfix': {
            ...
            'uuid': ('django.db.models.fields.TextField', [], {'default': "'c1a20cc1-9254-4c08-9b3a-c196ff0fde05'", 'unique': 'True'})
        },
        u'cityfix.fixtype': {
        ...
        u'cityfix.pics': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pic': ('django.db.models.fields.TextField', [], {'null': 'True'})
        },
        u'cityfix.sitetype': {
