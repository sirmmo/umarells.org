...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CityFix.operator'
        db.add_column(u'cityfix_cityfix', 'operator',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cityfix.Operator']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CityFix.operator'
        db.delete_column(u'cityfix_cityfix', 'operator_id')
    ...
    models = {
        ...
        u'cityfix.cityfix': {
            ...
            'uuid': ('django.db.models.fields.TextField', [], {'default': "'ca50f77b-3918-42b3-a067-1d4be65e27e6'", 'unique': 'True'})
        },
        u'cityfix.fixtype': {
