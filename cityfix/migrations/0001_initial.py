...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FixType'
        db.create_table(u'cityfix_fixtype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'cityfix', ['FixType'])

        # Adding model 'CityFix'
        db.create_table(u'cityfix_cityfix', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('fixtype', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cityfix.FixType'])),
        ))
        db.send_create_signal(u'cityfix', ['CityFix'])


    def backwards(self, orm):
        # Deleting model 'FixType'
        db.delete_table(u'cityfix_fixtype')

        # Deleting model 'CityFix'
        db.delete_table(u'cityfix_cityfix')
