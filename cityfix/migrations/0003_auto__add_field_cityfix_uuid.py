...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CityFix.uuid'
        db.add_column(u'cityfix_cityfix', 'uuid',
                      self.gf('django.db.models.fields.TextField')(default='94380810-187e-4c62-a15f-b3a561cc0e0c', unique=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CityFix.uuid'
        db.delete_column(u'cityfix_cityfix', 'uuid')
    ...
    models = {
        ...
        u'cityfix.cityfix': {
            ...
            'uuid': ('django.db.models.fields.TextField', [], {'default': "'e41e55e7-f899-4da8-9264-1b5f32578032'", 'unique': 'True'})
        },
        u'cityfix.fixtype': {
